        ...
        <div class="col-md-12">
          <div class="tile">
           ...
           <div class="tile-tile-w-btn">
            ...
            <p><button class="btn btn-info-btn" onclick="editarContenido(<?= $data['contenido_id']; ?>)"><?=$data['contenido_id']; ?>)"><i class="fa fa-edit"></i>Editar Contenido</i>
            </button> <button class="btn btn-danger icon-btn" onclick="eliminarContenido(<?= $data['contenido_id'] ?>)"><i class="fa fa-delet"></i>Eliminar Contenido</button>
            <a class="btn btn-warning icon-btn" href="evaluacion.php?curso=<?= $data['pm_id']; ?>&contenido=<?= $data['contenido_id']; ?>"><i class="fa fa-edit"></i>Asignar evaluacion</a></p>
          </div>
          <div class= "tile-body">
